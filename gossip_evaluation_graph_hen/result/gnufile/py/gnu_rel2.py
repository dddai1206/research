...
TMPL1[1]=' \\"%1.1f_rel.png\\"'
TMPL1[2]=' \\n set style line 1 lt 3  \\n plot '

TMPL2[0]=' \\"%1.6f_biconnected_%d_rel\\"'
TMPL2[1]=' title \\"GAMBC reliability fanout = %d\\" with errorlines  pt %d ps %d lw 2 lc rgb \\"#%s\\",'

TMPL2[2]=' \\"%1.6f_fixed_fanout_%d_rel\\"'
TMPL2[3]=' title \\"FFG reliability fanout = %d\\" with errorlines  pt %d ps %d lw 2 lc rgb \\"#%s\\",'

TMPL3[0]=' \\"%1.6f_decision_rel\\"'
TMPL3[1]=' title \\"MBCMDA reliability\\" with errorlines  pt 4 ps 5 lw 2 lc rgb \\"#0000B0\\" \"'
TMPL3[2]=' | gnuplot'
