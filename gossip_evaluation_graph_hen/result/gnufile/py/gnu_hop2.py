...
TMPL2=4*[0]
TMPL3=3*[0]
TMPL1[0]='echo \"set xlabel \\" k \\" \\n set ylabel \\" Max of hops \\" \\n set xrange[0:1] \\n set yrange [0:25] \\n  set terminal png size 1024,1024\\n set out '
TMPL1[1]=' \\"%1.1f_hop.png\\"'
TMPL1[2]=' \\n set style line 1 lt 3  \\n plot '

TMPL2[0]=' \\"%1.6f_biconnected_%d_hop\\"'
TMPL2[1]=' title \\"GAMBC Max of hops fanout = %d\\" with errorlines  pt %d ps %d lw 2 lc rgb \\"#%s\\",'

TMPL2[2]=' \\"%1.6f_fixed_fanout_%d_hop\\"'
TMPL2[3]=' title \\"FFG Max of hops fanout = %d\\" with errorlines  pt %d ps %d lw 2 lc rgb \\"#%s\\",'

TMPL3[0]=' \\"%1.6f_decision_hop\\"'
TMPL3[1]=' title \\"MBCMDA Max of hops\\" with errorlines  pt 4 ps 5 lw 2 lc rgb \\"#0000B0\\" \"'
TMPL3[2]=' | gnuplot'
