...
TMPL1[1]=' \\"%1.1f_%1.1f_mes_by_hop.png\\"'#dp,rp
TMPL1[2]=' \\n set style line 1 lt 3  \\n plot '

TMPL2[0]=' \\"%1.6f_%1.6f_biconnected_%d_mes_by_hop\\"'#dp,rp,k
TMPL2[1]=' title \\"GAMBC mes fanout = %d\\" with lp  pt %d ps 1.3 lw 2 lc rgb \\"#%s\\",'#k,pt,color

TMPL2[2]=' \\"%1.6f_%1.6f_fixed_fanout_%d_mes_by_hop\\"'#dp,rp,k
TMPL2[3]=' title \\"FFG mes fanout = %d\\" with lp  pt %d ps 1 lw 2 lc rgb \\"#%s\\",'#k,pt,color

TMPL3[0]=' \\"%1.6f_%1.6f_decision_mes_by_hop\\"'#dp,rp
TMPL3[1]=' title \\"MBCMDA mes\\" with lp  pt 4 ps 1 lw 2 lc rgb \\"#0000B0\\" \"'
TMPL3[2]=' | gnuplot'
